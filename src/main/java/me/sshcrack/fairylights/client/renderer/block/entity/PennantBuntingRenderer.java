...
public class PennantBuntingRenderer extends ConnectionRenderer<PennantBuntingConnection> {
    private static final Identifier TRIANGLE_MODEL = new Identifier(FairyLightsMod.ModID, "entity/triangle_pennant");

    private static final Identifier SPEARHEAD_MODEL = new Identifier(FairyLightsMod.ModID, "entity/spearhead_pennant");

    private static final Identifier SWALLOWTAIL_MODEl = new Identifier(FairyLightsMod.ModID, "entity/swallowtail_pennant");

    private static final Identifier SQUARE_MODEL = new Identifier(FairyLightsMod.ModID, "entity/square_pennant");
