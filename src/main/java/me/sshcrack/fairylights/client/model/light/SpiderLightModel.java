...
public class SpiderLightModel extends ColorLightModel {
    ...
    public static TexturedModelData createLayer() {
        ...
        final LightModel.BulbBuilder abdomen = bulb.createChild("abdomen", 20, 54);
        abdomen.addBox(-2.5F, -5.0F, -2.5F, 5, 5, 5, 0);
        final LightModel.BulbBuilder pedicel = abdomen.createChild("pedicel", 6, 0);
        pedicel.setPosition(0, -6.0F, 0);
        pedicel.addBox(-1, 0, -1, 2, 1, 2, 0);
        final LightModel.BulbBuilder cephalothorax = pedicel.createChild("cephalothorax", 40, 57);
        cephalothorax.setPosition(0, -2.25F, 0);
        cephalothorax.addBox(-2, 0, -2, 4, 3, 4, 0);
        final LightModel.BulbBuilder cheliceraLeft = cephalothorax.createChild("cheliceraLeft", 0, 0);
        ...
        final LightModel.BulbBuilder cheliceraRight = cephalothorax.createChild("cheliceraRight", 0, 0);
    ...
    private static void createLegs(final LightModel.LightMeshHelper helper, final LightModel.BulbBuilder bulb, final int side) {
        final LightModel.BulbBuilder legs = bulb.createChild("legs_" + side, 0, 0);
        legs.setAngles(0.0F, FLMth.PI * side, 0.0F);
        final LightModel.BulbBuilder leg1 = legs.createChild("leg1_" + side, 21, 45);
        ...
        final LightModel.BulbBuilder leg1Lower = leg1.createChild("leg1Lower_" + side, 21, 45);
        leg1Lower.setPosition(4.59F, 0, -0.24F);
        leg1Lower.addBox(0, -0.5F, -0.5F, 4, 1, 1, -0.075F);
        leg1Lower.setAngles(0, -1.0471975511965976F, 0);
        final LightModel.BulbBuilder leg2 = legs.createChild("leg2_" + side, 21, 45);
        ...
        final LightModel.BulbBuilder leg2Lower = leg2.createChild("leg2Lower_" + side, 21, 45);
        leg2Lower.setPosition(3.65F, 0, -0.13F);
        leg2Lower.addBox(0, -0.5F, -0.5F, 4, 1, 1, -0.075F);
        leg2Lower.setAngles(0, -0.7853981633974483F, 0);
        final LightModel.BulbBuilder leg3 = legs.createChild("leg3_" + side, 21, 45);
        ...
        final LightModel.BulbBuilder leg3Lower = leg3.createChild("leg3Lower_" + side, 21, 45);
        leg3Lower.setPosition(3.81F, 0, -0.05F);
        leg3Lower.addBox(0, -0.5F, -0.5F, 4, 1, 1, -0.075F);
        leg3Lower.setAngles(0, -0.4363323129985824F, 0);
        final LightModel.BulbBuilder leg4 = legs.createChild("leg4_" + side, 21, 45);
        ...
        final LightModel.BulbBuilder leg4Lower = leg4.createChild("leg4Lower_" + side, 21, 45);
