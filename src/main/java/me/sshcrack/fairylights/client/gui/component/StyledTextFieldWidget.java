...
public final class StyledTextFieldWidget extends ClickableWidget {
    ...
    public void updateStyling(final Formatting styling, final boolean state) {
    ...
    public void withStyling(final Formatting styling, final boolean state) {
    ...
    private void drawSelectionHighlight(final MatrixStack stack, int startX, int startY, int endX, int endY) {
    ...
    public StyledString getClipboardString() {
        final String str = MinecraftClient.getInstance().keyboard.getClipboard();
        if (str.indexOf('\u00a7') == -1) {
    ...
    private void setClipboardString(final StyledString value) {
        MinecraftClient.getInstance().keyboard.setClipboard(value.toString());
    }
    ...
    private static StyledString trimToWidth(final StyledString styledString, final TextRenderer font, final int width) {
        return trimToWidth(styledString, font, width, false);
    }

    private static StyledString trimToWidth(final StyledString styledString, final TextRenderer font, final int width, final boolean reverse) {
        final char[] chars = styledString.toCharArray();
        final Style[] styling = styledString.getStyling();
