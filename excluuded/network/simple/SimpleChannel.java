...
package me.sshcrack.fairylights.util.forge.network.simple;

import io.netty.buffer.Unpooled;
import me.sshcrack.fairylights.util.forge.network.NetworkDirection;
...
import me.sshcrack.fairylights.util.forge.network.PacketDistributor;
...
public class SimpleChannel
{
    ...
    public static class MessageBuilder<MSG>  {
        ...
        /**
         * Set the message encoder, which writes this message to a {@link PacketByteBuf}.
         * <p>
        ...
        /**
         * Set the message decoder, which reads the message from a {@link PacketByteBuf}.
         * <p>
